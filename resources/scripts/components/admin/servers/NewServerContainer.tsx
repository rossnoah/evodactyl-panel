...
const NewServerContainer = () => {
    ...
    return (
        <AdminLayout title={'New Server'} subtitle={'Add a new server to the panel.'} showFlashKey={'admin:servers:new'} breadcrumbs={[{ label: 'Admin', to: '/admin' }, { label: 'Servers', to: '/admin/servers' }, { label: 'New Server' }]} showFlashKey={'admin:servers:new'}>
