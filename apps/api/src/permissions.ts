/**
 * Static permission map for server subuser permissions.
 * Mirrors app/Models/Permission.php
 */

// Permission action constants
export const ACTION_WEBSOCKET_CONNECT = 'websocket.connect';
export const ACTION_CONTROL_CONSOLE = 'control.console';
export const ACTION_CONTROL_START = 'control.start';
export const ACTION_CONTROL_STOP = 'control.stop';
export const ACTION_CONTROL_RESTART = 'control.restart';

export const ACTION_DATABASE_READ = 'database.read';
export const ACTION_DATABASE_CREATE = 'database.create';
export const ACTION_DATABASE_UPDATE = 'database.update';
export const ACTION_DATABASE_DELETE = 'database.delete';
export const ACTION_DATABASE_VIEW_PASSWORD = 'database.view_password';

export const ACTION_SCHEDULE_READ = 'schedule.read';
export const ACTION_SCHEDULE_CREATE = 'schedule.create';
export const ACTION_SCHEDULE_UPDATE = 'schedule.update';
export const ACTION_SCHEDULE_DELETE = 'schedule.delete';

export const ACTION_USER_READ = 'user.read';
export const ACTION_USER_CREATE = 'user.create';
export const ACTION_USER_UPDATE = 'user.update';
export const ACTION_USER_DELETE = 'user.delete';

export const ACTION_BACKUP_READ = 'backup.read';
export const ACTION_BACKUP_CREATE = 'backup.create';
export const ACTION_BACKUP_DELETE = 'backup.delete';
export const ACTION_BACKUP_DOWNLOAD = 'backup.download';
export const ACTION_BACKUP_RESTORE = 'backup.restore';

export const ACTION_ALLOCATION_READ = 'allocation.read';
export const ACTION_ALLOCATION_CREATE = 'allocation.create';
export const ACTION_ALLOCATION_UPDATE = 'allocation.update';
export const ACTION_ALLOCATION_DELETE = 'allocation.delete';

export const ACTION_FILE_READ = 'file.read';
export const ACTION_FILE_READ_CONTENT = 'file.read-content';
export const ACTION_FILE_CREATE = 'file.create';
export const ACTION_FILE_UPDATE = 'file.update';
export const ACTION_FILE_DELETE = 'file.delete';
export const ACTION_FILE_ARCHIVE = 'file.archive';
export const ACTION_FILE_SFTP = 'file.sftp';

export const ACTION_STARTUP_READ = 'startup.read';
export const ACTION_STARTUP_UPDATE = 'startup.update';
export const ACTION_STARTUP_DOCKER_IMAGE = 'startup.docker-image';

export const ACTION_SETTINGS_RENAME = 'settings.rename';
export const ACTION_SETTINGS_REINSTALL = 'settings.reinstall';

export const ACTION_ACTIVITY_READ = 'activity.read';

/**
 * Permission groups with descriptions (matches PHP $permissions array).
 */
export const permissionGroups: Record<string, { description: string; keys: Record<string, string> }> = {
  websocket: {
...
/**
 * Get a flat list of all permission strings.
 */
export function getAllPermissions(): string[] {
  const permissions: string[] = [];
  for (const [group, data] of Object.entries(permissionGroups)) {
    for (const key of Object.keys(data.keys)) {
      permissions.push(`${group}.${key}`);
    }
  }
  return permissions;
}
