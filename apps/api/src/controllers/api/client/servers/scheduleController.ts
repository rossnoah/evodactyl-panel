...
export class ScheduleController {
    ...
    async index(req: Request, res: Response): Promise<void> {
        ...
        const response = await fractal(req).collection(schedules).transformWith(transformer).toArray();
    ...
    async store(req: Request, res: Response): Promise<void> {
        ...
        const response = await fractal(req).item(schedule).transformWith(transformer).toArray();
    ...
    async view(req: Request, res: Response): Promise<void> {
        ...
        const response = await fractal(req).item(scheduleWithTasks).transformWith(transformer).toArray();
     ...
     */
    private getNextRunAt(_req: Request): Date {
        try {
