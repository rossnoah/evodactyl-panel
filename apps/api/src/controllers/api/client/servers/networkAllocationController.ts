...
export const index = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const response = await fractal(req).collection(withServer).transformWith(transformer).toArray();
...
export const update = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const transformer = ClientAllocationTransformer.fromRequest(req);
        const response = await fractal(req).item(withServer).transformWith(transformer).toArray();
