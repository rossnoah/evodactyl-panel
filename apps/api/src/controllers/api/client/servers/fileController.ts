...
export class FileController {
    ...
    async directory(req: Request, res: Response): Promise<void> {
        ...
        const response = await fractal(req).collection(contents).transformWith(transformer).toArray();
    ...
    async download(req: Request, res: Response): Promise<void> {
        ...
        await activityFromRequest(req).event('server:file.download').property('file', filePath).log();

        res.json({
            object: 'signed_url',
            attributes: {
                url: `${getConnectionAddress(node)}/download/file?token=${token}`,
            },
        });
    }
    ...
    async write(req: Request, res: Response): Promise<void> {
        ...
        await activityFromRequest(req).event('server:file.write').property('file', filePath).log();
    ...
    async copy(req: Request, res: Response): Promise<void> {
        ...
        await activityFromRequest(req).event('server:file.copy').property('file', req.body.location).log();
    ...
    async compress(req: Request, res: Response): Promise<void> {
        ...
        const response = await fractal(req).item(file).transformWith(transformer).toArray();
