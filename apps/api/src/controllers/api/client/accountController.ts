...
export async function updatePassword(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        if (!current_password || !password || !password_confirmation) {
            throw new ValidationException([
                ...(current_password
                    ...
                    : [
                          {
                              sourceField: 'current_password',
                              rule: 'required',
                              detail: 'The current password field is required.',
                          },
                      ]),
                ...(password
                    ? []
                ...
                ...(password_confirmation
                    ...
                    : [
                          {
                              sourceField: 'password_confirmation',
                              rule: 'required',
        ...
        await activityFromRequest(req).event('user:account.password-changed').log();
